...
using RestAPICompleted.Services;
...
namespace RestAPICompleted
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRepository<MemberEntity>, RepositoryMember>();
            services.AddTransient<IMembersEntityService, MembersEntityService>();
